...
const useRoutes = (): Partial<Routes> => {
  return {
    ...
    [Pages.Register]: {
      component: asyncComponentLoader(() => import('@/pages/Auth/Signup')),
      path: '/signup',
      title: 'Sign Up',
      visibleTo: ['startup', 'coach'],
      requiresAuth: false,
    ...
    [Pages.ConfirmEmail]: {
      component: asyncComponentLoader(() => import('@/pages/Auth/ConfirmEmail')),
    ...
    [Pages.EmailConfirmed]: {
      component: asyncComponentLoader(() => import('@/pages/Auth/EmailConfirmed')),
      path: '/auth/callback',
    ...
    [Pages.NoStartup]: {
      component: asyncComponentLoader(() => import('@/pages/Auth/NoStartup')),
      path: '/no-startup',
    ...
    [Pages.UpdateProfile]: {
      component: asyncComponentLoader(() => import('@/pages/User/ProfileForm')),
    ...
    [Pages.StartupFormStep]: {
      component: asyncComponentLoader(() => import('@/pages/Startup/StartupFormStep')),
      path: '/startup/edit/:stepId',
    ...
    [Pages.StartupCreate]: {
      component: asyncComponentLoader(() => import('@/pages/Startup/StartupForm')),
      path: '/startup/create',
    ...
    [Pages.StartupTeam]: {
      component: asyncComponentLoader(() => import('@/pages/Startup/StartupTeam')),
      path: '/startup/team',
      title: 'Manage Team',
      visibleTo: ['startup'],
      requiresAuth: true,
    ...
    [Pages.TeamAssessment]: {
      component: asyncComponentLoader(() => import('@/pages/Tools/TeamAssessment')),
    ...
    [Pages.UserValues]: {
      component: asyncComponentLoader(() => import('@/pages/Tools/UserValues')),
      path: '/tools/user-values',
      title: 'Your Values',
      visibleTo: ['startup'],
      requiresAuth: true,
      requiresStartup: false,
    ...
    [Pages.Interviews]: {
      component: asyncComponentLoader(() => import('@/pages/Tools/Interviews')),
    ...
    [Pages.PitchDeck]: {
      component: asyncComponentLoader(() => import('@/pages/Tools/PitchDeck')),
    ...
    [Pages.StakeholderMap]: {
      component: asyncComponentLoader(() => import('@/pages/Tools/StakeholderMap')),
    ...
    [Pages.Persona]: {
      component: asyncComponentLoader(() => import('@/pages/Tools/Persona')),
      path: '/tools/persona',
      title: 'User Personas',
      visibleTo: ['startup'],
      requiresAuth: true,
